...
| graphdb\_version | GraphDB version | `string` | `"10.6.4"` | no |
...
| parameter\_store\_cmk\_alias | The alias for the CMK key. | `string` | `"graphdb-cmk-key"` | no |
...
| graphdb\_parameter\_store\_cmk\_alias | The alias for the CMK key. | `string` | `"graphdb-cmk-key"` | no |
