...
data "cloudinit_config" "graphdb_user_data" {
  ...
  part {
    ...
    content = templatefile("${path.module}/templates/04_gdb_conf_overrides.sh.tpl", {
      ...
      graphdb_data_encryption_keystore_alias : var.graphdb_data_encryption_keystore_alias != null ? var.graphdb_data_encryption_keystore_alias : ""
